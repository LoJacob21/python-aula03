...
while quantidade_chances > 0:
    ...
    # Mostra todas as letras já tentadas
    if lista_letras_tentadas:
        print("Letras já tentadas:", ", ".join(lista_letras_tentadas))

    falta_letras = False

    for letra in palavra_sorteada:
        if letra in lista_letras_tentadas:
            print(letra, end=" ")
        else:
            print("_", end=" ")
            falta_letras = True
    ...
    lista_letras_tentadas.append(palpite)
